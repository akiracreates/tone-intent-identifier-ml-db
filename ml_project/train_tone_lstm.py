...
def build_tone_bilstm_model(vocab_size: int, max_seq_len: int, num_classes: int):
    model = Sequential([
...
def main():
    ...
    model = build_tone_bilstm_model(vocab_size, MAX_SEQ_LEN, num_classes)
    model.summary()

    model_path = os.path.join(OUTPUT_MODEL_DIR, "tone_bilstm_model.h5")
    ...
    final_model_path = os.path.join(OUTPUT_MODEL_DIR, "tone_bilstm_model_final.h5")
